            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-header bg-primary">
                        <h4 class="modal-title text-white">Tambah Jabatan</h4>
                        <button type="button"
                    ...
                    <div class="modal-body">
                        <form action="./jabatan/tambah_jabatan" method="post" enctype="multipart/form-data">
                        @csrf
                            <div class="form-group row">
                                <label for="qtitle" class="col-form-label form-label col-md-3">JABATAN</label>
                                <div class="col-md-9">
