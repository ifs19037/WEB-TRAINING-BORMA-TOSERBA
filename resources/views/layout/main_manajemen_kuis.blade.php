                    ...
                    <div class="modal-body">
                        ...
                        @csrf
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-2">
                                    <div class="custom-file">
                                        <input name="jam_durasi_pengerjaan" type="text" class="form-control" maxlength="1" style="max-width:50px" onkeypress="return hanyaAngka(event)" required>
                                    </div>
                                </div>
                                <div class="col-md-2">
                                    <div class="custom-file">
                                ...
                                <div class="col-md-2">
                                    <div class="custom-file">
                                        <input name="menit_durasi_pengerjaan" type="text" class="form-control" maxlength="2" style="max-width:50px" onkeypress="return hanyaAngka(event)" required>
                                    </div>
                                </div>
                                <div class="col-md-1">
                                    <div class="custom-file">
